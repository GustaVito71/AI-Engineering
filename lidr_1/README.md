...
```
Prompt (o 'modelos', 'switch <proveedor>', 'salir'): switch gemini
-> Cambiado a gemini

Proveedor actual: gemini
Proveedores disponibles: openai, anthropic, gemini, deepseek

Prompt (o 'modelos', 'switch <proveedor>', 'salir'): modelos
  Modelos de gemini: ['gemini-3.6-flash', 'gemini-3.5-flash', ...]

Prompt (o 'modelos', 'switch <proveedor>', 'salir'): ¿Qué modelo eres?
...
El proveedor inicial se elige con la variable `LLM_DEFAULT` del `.env` (por defecto `anthropic`).
